...
plot(NA,xlim=c(1,8),ylim=c(-2,2),xlab="Species",ylab="ln(connected/isolated)",xaxt="n")
...
#par(mfrow=c(2,2))
for(i in 1:length(S)){ 
 plot(NA,xlim=c(1,8),ylim=c(-4,3.5),main=paste(S[i],"mL"),xlab="Species",ylab="ln(connected/isolated)",xaxt="n")
...
plot(NA,xlim=c(1,4),ylim=c(-1,1),xlab="Exp. time",ylab="ln(connected/isolated)",xaxt="n")
...
plot(NA,xlim=c(1,4),ylim=c(-1.5,1.5),xlab="Patch size",ylab="ln(connected/isolated)",xaxt="n")
...
ggplot(mapping=aes(x=as.factor(Size),y=prot.ab),data=X1) +
  geom_boxplot() + facet_wrap(~ day)   



ggplot(mapping=aes(x=day,y=prot.ab),data=X1) +
...
ggplot(mapping=aes(x=day.cont,y=prot.rich),data=X1) +
